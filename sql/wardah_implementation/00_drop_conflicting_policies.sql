-- Wardah ERP - Drop All Conflicting RLS Policies
-- Run this first to remove all existing policies that are causing conflicts
...
-- Success message
SELECT 'All conflicting policies dropped successfully' as result;