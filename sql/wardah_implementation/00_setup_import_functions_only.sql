...
-- Run this to ensure import functions exist

-- Create or replace the import_chart_of_accounts function
...
-- Create or replace the import_gl_mappings function
...
-- Success message
SELECT 'Import functions created successfully' as result;