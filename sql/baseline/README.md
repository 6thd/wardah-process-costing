...
|---|---|---|---|
| `000_schema_baseline_20260904_064514.sql` | 2026-09-04 | 187 | 1284 KB / 36,399 سطر |

المحتوى المتحقق بعد إعادة البناء: 133 جدول · 262 دالة · 318 policy

## البيانات المرجعية الحالية

| الملف | migration_cutoff | الجداول | الصفوف |
|---|---|---|---|
| `001_system_reference_data_20260904_064514.sql` | 187 | 5 | 263 |
