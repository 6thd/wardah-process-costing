-- =======================================
-- Import Functions for Wardah ERP
-- =======================================
...
DO $$
BEGIN
    RAISE NOTICE '✅ Import Functions Created Successfully!';
    RAISE NOTICE '📋 Next steps:';
    RAISE NOTICE '1. Import Chart of Accounts using import_chart_of_accounts()';
    RAISE NOTICE '2. Import GL Mappings using import_gl_mappings()';
END $$;