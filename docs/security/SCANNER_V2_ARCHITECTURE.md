...
#243 remains a separate tracked issue until explicitly reconciled; this document does not close it.
...
6. Reconcile #243 into v2 acceptance.
...
- #243 classes are either closed or explicitly governed by a separately approved fail-closed rule;
