...
> ## ✅ مدموجة — هذه الوثيقة سجل مراجعة، لا مرجعًا نافذًا
>
> دُمجت هذه المراجعة بالكامل في
> **`docs/security/PERMISSIONS_MATRIX_PLAN_20260724.md` — النسخة v2** بتاريخ 2026-07-25،
> بعد التحقق المستقل من كل بند مقابل القاعدة الحية والفروع.
>
> **المرجع النافذ للتنفيذ هو v2 وحدها.** تُحفظ هذه الوثيقة كسجل للمراجعة ولا تُحذف.
>
> أُضيف في v2 بندٌ لم يرد هنا: **تعارض 148/149 ليس مسألة ترقيم بل بوابة CI صلبة** —
> خطوة `Validate migration numbering` تفشل عند أي رقم مفقود دون 155،
> فدمج فرع GRN شرط سابق لـP1، ويُمنع تسجيل الرقمين في `skipped_migration_numbers.yml`.
> التفاصيل في §5.0 من v2.
