...
**نقطة المراجعة:** `main@1fae01255617ca1e1ed32d99f1c421615221f1ae`
مع زوج baseline مولّد في الرأس `26366ab877fca49f89d227c03575a7ade391b83d`
لـDraft PR #224.

**حد السلطة:** قراءة Production التعريفية وتوثيق فقط. لا يفوض هذا الملف دمج
PR #224، أو تغيير بيانات HR، أو تطبيق migration إضافية، أو إخراج PR #221 من Draft.
...
- Draft PR #224: رأس `26366ab877fca49f89d227c03575a7ade391b83d`.
...
- إبقاء Draft PR #224 موصوفًا بأنه **مولّد وقيد المراجعة**، لا منشورًا على
  `main` قبل قرار الدمج.
...
1. مراجعة #224 ثم قرار Ready/merge مستقلان.
2. بعد نشر baseline، إعادة استهداف PR التوثيق إلى `main` وفحص drift قبل أي Ready.
3. حسم OQ-10 تحت #156 باختبار non-admin حقيقي قبل قرار دمج #221.
4. متابعة Round 3 حسب سجل المخزون؛ لا يبدأ Phase 0 بسبب نجاح 188 وحدها.
