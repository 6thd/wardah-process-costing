...
المدموجة والمطبقة حولت `consume_materials_for_mo` إلى غلاف للمسار القانوني مع
إبقاء ACL بعد 185؛ postflight أثبت صفر مراجع `stock_moves` وثبات البيانات، بينما
Red/Green واختبار السباق يثبتان السلوك. ثبات العدد وحده يظل غير كافٍ قبل فتح
سيناريوهات المختبر.
