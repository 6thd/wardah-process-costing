...
**الإجمالي:** 31 ثابتًا — **12 سندها `NONE`** (لا يكشفها إلا هذا المختبر)
...
**سند:** `DB` (Migrations 169، 176، 178، 180) · **خطورة:** S0 · **نقطة:** CONT
...
| السند | العدد | الدلالة |
|---|---|---|
| `NONE` | 12 | **لا يكشفها إلا هذا المختبر** — مبرر وجوده |
...
|---|---|---|
| S0 | 19 | توقف التشغيلة وتجمّد الأدلة |
