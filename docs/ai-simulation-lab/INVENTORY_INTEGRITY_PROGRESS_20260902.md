...
> بعد الالتزام: لا حركات نشطة، ولا فروقات في `validate_stock_balance`،
> وأرصدة الأصناف الأربعة `001`/`PP810837`/`RM-010`/`RM-042` صفر في المنتج
> والمستودع. أُلغيت الاستلامات الثلاثة وأمرا الشراء وقيدا GL المسودتان
> والتسوية، وسُجلت لقطة قبل/بعد واحدة في `audit_logs`. حالة `INV-01`
> التاريخية وتكرار `ADJ-000001` لم يعودا نشطين؛ عقد منع تكرار الحركات
> واستمرارية الرصيد مستقبلًا مسار مستقل. سجل Production ما زال عند M189؛
> لم يُطبّق M190 أو M191.
