...
**State:** Applied and verified on Production (`Manufacturing Process`, `uutfztmqvajmsxnrqeiv`) on 2026-08-05, ledger version `20260805151524`. Merged to `main` via PR #96, squash commit `0bcce21a`.
