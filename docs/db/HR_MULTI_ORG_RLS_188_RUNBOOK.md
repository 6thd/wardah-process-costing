...
- Baseline cutoff 188 was generated by run `33952026388` into Draft PR #224;
  publication to `main` remains a separate review/merge decision.
...
with 133 tables, 262 functions, and 318 policies. The generated branch is reviewed
in Draft PR #224; neither this evidence nor that Draft authorizes its merge.
