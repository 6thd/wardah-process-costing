...
> — FIFO/LIFO/متوسط مرجّح/متحرّك، مُختبَر). **⚠️ باقٍ**: ذرّية المخزون الكاملة (بورت
> دفتر المخزون/التقييم إلى نفس الـ RPC) — دفعة مخصّصة لاحقة؛ حالياً الاستلام ذرّي
> محاسبياً (مستند+GRNI+PO) بينما تحديث bins/SLE يبقى خطوة تالية بمحرّك حقيقي.
