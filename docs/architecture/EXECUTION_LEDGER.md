...
> **Dated addendum — 2026-09-25 (`main@0761d567`, after the PR #241 / M191 merge).** The rows below are unchanged history. This addendum records the manufacturing rows' re-derived state on a disposable PostgreSQL 17 database (evidence: `docs/db/manufacturing-inventory-red-20260925/`; summary: [`MANUFACTURING_INVENTORY_RECONCILIATION_20260925.md`](./MANUFACTURING_INVENTORY_RECONCILIATION_20260925.md)):
>
