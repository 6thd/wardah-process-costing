...
-- 3. Create the user_organizations table with proper structure
...
-- 4. Add constraint for role column
...
-- 7. Create policies for organizations table
...
-- 8. Create policies for user_organizations table
...
-- 10. Create a default organization
...
-- 11. Create a user profile for the existing auth user (replace with your actual user ID)
...
-- 12. Associate users with the default organization
...
-- 13. Update any gl_accounts with NULL tenant_id to use the default organization
UPDATE gl_accounts 
