...
-- 3. إنشاء المنظمة الافتراضية
INSERT INTO organizations (id, name, code, settings, is_active)
VALUES ('00000000-0000-0000-0000-000000000001', 'وردة البيان', 'WARD', '{}', true)
ON CONFLICT (id) DO NOTHING;

-- 4. ربط المستخدم بالمنظمة
...
-- 5. التأكد من وجود جدول gl_accounts
...
-- 9. حذف السياسات القديمة (إن وجدت)
...
-- 10. إعادة تفعيل RLS مع سياسة صحيحة
ALTER TABLE gl_accounts ENABLE ROW LEVEL SECURITY;

-- 11. إنشاء سياسات RLS جديدة
